...
import (
	...
	infrastructurev1alpha1 "github.com/PatrickLaabs/cluster-api-provbider-docker/api/v1alpha1"
	"github.com/PatrickLaabs/cluster-api-provbider-docker/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "01e79c74.cluster.x-k8s.io",
